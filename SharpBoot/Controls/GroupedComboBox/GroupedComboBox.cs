    ...
    public class GroupedComboBox : ComboBox, IComparer
    {
        ...
        public IComparer SortComparer
        {
            ...
            set
            {
                ...
                if (value == this) throw new ArgumentException("The owning control cannot be used as a comparer.", nameof(value));
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            if (e.Index >= 0 && e.Index < Items.Count)
            {
                ...
                // determine grouping
                var isGroupStart = IsGroupStart(e.Index, out var groupText) && !comboBoxEdit;
        ...
        protected override void OnMeasureItem(MeasureItemEventArgs e)
        {
            ...
            if (IsGroupStart(e.Index, out var groupText))
            {
